...
WFC_VERSION="4.4.6"
RELEASE_URL="https://github.com/balena-os/wifi-connect/releases/download/v$WFC_VERSION/wifi-connect-v$WFC_VERSION-linux-rpi.tar.gz"
...
install_custom_ui() {
    ensure tar -xzf "/hoobs-connect.tar.gz"
    ...
    ensure rm -f "/hoobs-connect.tar.gz"
